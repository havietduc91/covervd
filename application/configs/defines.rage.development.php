...
define('SITE_URL', 'http://rage.local');
//define('SITE_URL', 'http://www.oakq.com');
define('SAND_ASSETS_CDN', 'http://rageassets.local//');
define('ASSETS_CDN', 'http://rageassets.local/');

define('STATIC_CDN', 'http://ragestatic.local/');
define('STATIC_PATH', PUBLIC_PATH . '/ufiles/');
define('NOREPLY_EMAIL', 'hoibinet@gmail.com');
define('DOMAIN', 'rage.local');
...
define('RDB_DICT_DB', 16); //[0,1,2] is kept for eekip, [3,4,5] for school,, [6,7,8] for taxi
define('RDB_CACHE_DB', 17);
define('RDB_QUEUE_DB', 18);
...
define('WM_DIR', PUBLIC_PATH . "/watermark/");
