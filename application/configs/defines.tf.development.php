...
define('SITE_URL', 'http://thai.local');
//define('SITE_URL', 'http://www.oakq.com');
//define('ASSETS_CDN', 'http://cdn.hoibi.net/');
define('SAND_ASSETS_CDN', 'http://sandassets.local/'); //or http://assets1.sandphp.com
define('ASSETS_CDN', 'http://funassets.local/'); //should have been assets.hoibi.net
...
define('FB_APP_ID', '533029230090669');//numbers pagination links at a time
define('FB_APP_SECRET', '46c274c2ff6af0ff36ae1b3aeb9e2993');//numbers pagination links at a time
