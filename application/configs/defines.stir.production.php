...
define('SITE_URL', 'http://funstir.com');
...
define('STATIC_CDN', 'http://s.funstir.com/');
define('STATIC_PATH', PUBLIC_PATH . '/ufiles/');
define('DESIGN_PATH', 'http://funstir.com/design/');
define('NOREPLY_EMAIL', 'no-reply@funstir.com');
define('DOMAIN', 'funstir.com');
...
//SOCIAL configs
define('NS_PREFIX', 'funstircom');
define('FB_APP_ID', '742545272462351');//numbers pagination links at a time
define('FB_APP_SECRET', 'a2652218054241b953133648870ce492');//numbers pagination links at a time
define('GA_ID', 'UA-2506382-1');

//Google
define('G_CLIENT_ID','139117437539-7o790oiu5hvf4hbpnk9a61mnhks4dklp.apps.googleusercontent.com');
define('G_CLIENT_SECRET','PyJydlo3KfmuqZOQnHDX2_gU');
define('G_APP_NAME','funstir.com');
