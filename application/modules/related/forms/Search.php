<?php 
class Related_Form_Search extends Cl_Form_Search
{
	...
	public function init()
	{
		parent::init();
		$this->method= "GET";
		$this->fieldList = array('name', 'status', 'product.id', 'product.name');
...
//    			'required' => true,
    		...
    		'op' => '$in',
    		'multiOptionsCallback' => array(array('Related_Form_Helper', 'getStatus')),
    		'defaultValue' => array()
    	),
    	'name' => array(
    		'type' => 'Text',
