 ...
 * @author tran
 */ 
class Feedback_IndexController extends Cl_Controller_Action_NodeIndex 
{
    public function init()
    {
        //$this->daoClass = "Cl_Dao_Node_Feedback";
        //$this->commentDaoClass = "Cl_Dao_Comment_Feedback";
    ...
    {
        $this->genericNew("Feedback_Form_New", "Dao_Node_Feedback", "Node");
        ...
        if(isset($this->ajaxData)) {
            ...
            if (isset($this->ajaxData['result'])) //success
            {
                ...
                else 
                {
                	...
                	$this->ajaxData['data'] = array('url' => node_link('feedback' , $this->ajaxData['result']));
                }
            }
        }
        Bootstrap::$pageTitle = 'Tạo phản hồi mới';
    }
    ...
    public function updateAction()
    {
         ...
         */
        $this->genericUpdate("Feedback_Form_Update", $this->daoClass ,"", "Node");
        Bootstrap::$pageTitle = 'Cập nhật phản hồi';
    }
    ...
    public function searchAction()
    {
        ...
        assure_perm("search_feedback");//by default
        $this->genericSearch("Feedback_Form_Search", $this->daoClass, "Node");
        Bootstrap::$pageTitle = 'Quản lý phản hồi';        
    }
    ...
    public function searchCommentAction()
    {
        ...
        $this->genericSearch("Feedback_Form_SearchComment", $commentClass, "");
    ...
    public function viewAction()
    {
        ...
        Bootstrap::$pageTitle = 'Chi tiết phản hồi';
    }
    
    public function deleteNodePermissionCheck($row)
    {
        if (has_perm("delete_feedback"))
    ...
    {
    	//TODO: Implement this
    	return has_perm("new_feedback_comment");
    }
    ...
    {
    	assure_role('admin_feedback');
    	$ids = $this->getStrippedParam('ids');
    	$in = explode(',', $ids);
    	$where = array('id' => array('$in' => $in));
    	Dao_Node_Feedback::getInstance()->delete($where);
