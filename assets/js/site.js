                ...
                ed
                        .addButton(
                                'mce_media',
                                {
                                    'title' : 'Embed a video',
                                    'image' : CL.ASSETS_CDN
                                            + '/common/images/youtube.gif',
                                    'onclick' : function() {
                                        var url = prompt(
                                                'Please enter the embed code for your video:',
                                                '');
                                        var code, regexRes;
                                        if (url == null)
                                            return;
                                        ...
                                        flash_mov = "http://www.youtube.com/v/"
                                                + code + "?version=3&f=videos";
                                        embedHTML = '';
                                        embedHTML += '<object>';
                                        ...
                                        embedHTML += '<embed src="'
                                                + flash_mov
                                                + '" type="application/x-shockwave-flash" wmode="transparent" type="application/x-shockwave-flash" width="530" height="315" allowscriptaccess="always" allowfullscreen="true"></embed></object>';

                                        // ed.execCommand('mceInsertContent',
                                        // false, '<img
                                        // src="http://img.youtube.com/vi/' +
                                        // code + '/0.jpg" class="mceItem"
                                        // alt="' + code + '"/>');
                                        ed.execCommand('mceInsertContent',
                                                false, embedHTML);
                                    }
