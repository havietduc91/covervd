<?php
class Dao_Node_Term extends Cl_Dao_Node
{
    public $nodeType = 'term';
	...
	public function afterUpdateComment($where, $data, $row)
	{
           ...
           )
        {
            ...
            Site_Codenamex_Dao_Comment_Term::getInstance()->update($cWhere, $dataUpdate);
	...
	{
	    //delete all comments
	    $commentDao = Site_Codenamex_Dao_Comment_Term::getInstance();
	 ...
	 */
	public function prepareFormDataForDaoInsert($dataArray = array(), $formName = "Term_Form_New")
	{
		return $dataArray;
	}	
