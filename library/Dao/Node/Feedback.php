<?php
class Dao_Node_Feedback extends Cl_Dao_Node
{
    public $nodeType = 'feedback';
	...
	public function afterUpdateComment($where, $data, $row)
	{
           ...
           )
        {
            ...
            Site_Codenamex_Dao_Comment_Feedback::getInstance()->update($cWhere, $dataUpdate);
	...
	{
	    //delete all comments
	    $commentDao = Site_Codenamex_Dao_Comment_Feedback::getInstance();
	 ...
	 */
	public function prepareFormDataForDaoInsert($dataArray = array(), $formName = "Feedback_Form_New")
	{
		return $dataArray;
	}	
